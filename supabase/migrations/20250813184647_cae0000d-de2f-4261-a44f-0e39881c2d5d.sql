-- Adicionar colunas para referenciar vendas na tabela cash_movements
ALTER TABLE public.cash_movements 
ADD COLUMN reference_type VARCHAR(50),
ADD COLUMN reference_id UUID;

-- Criar índice para melhor performance
CREATE INDEX idx_cash_movements_reference ON public.cash_movements(reference_type, reference_id);
